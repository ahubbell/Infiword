...
<?php get_template_part( 'layouts/woocommerce-page/full', 'width' ); ?>

<?php } ?>
<!-- /full-width layout -->

<!-- right-sidebar layout -->
<?php if ( get_theme_mod('foundationbuddy_woocommerce_page_layout') == 'right-sidebar' ) {  ?>

<?php get_template_part( 'layouts/woocommerce-page/right', 'sidebar' ); ?>
...
<?php get_template_part( 'layouts/woocommerce-page/left', 'sidebar' ); ?>
...
<?php get_template_part( 'layouts/woocommerce-page/dual', 'sidebar' ); ?>
...
<?php get_template_part( 'layouts/woocommerce-page/left', 'dual-sidebar' ); ?>
...
<?php get_template_part( 'layouts/woocommerce-page/right', 'dual-sidebar' ); ?>
<aside id="sidebar" class="small-12 large-3 columns">
    <?php get_sidebar(); ?>
</aside><!-- /#sidebar -->    
<aside id="sidebar" class="small-12 large-3 columns">
...
<!-- default fallback right sidebar -->
<?php if ( get_theme_mod('foundationbuddy_woocommerce_page_layout') == '' ) { ?>
