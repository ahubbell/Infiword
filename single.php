...
<!-- full-width layout -->
<?php if ( get_theme_mod('infiword_blog_page_layout') == 'full-width' ) {  ?>
...
<!-- left-sidebar layout -->   
<?php if ( get_theme_mod('infiword_blog_page_layout') == 'left-sidebar' ) {  ?>
...
<!-- /left-sidebar layout -->   
 ...
 <!-- dual-sidebar layout -->      
<?php if ( get_theme_mod('infiword_blog_page_layout') == 'dual-sidebar' ) {  ?>
...
<?php if ( get_theme_mod('infiword_blog_page_layout') == 'left-dual-sidebar' ) { ?>
...
<?php if ( get_theme_mod('infiword_blog_page_layout') == 'right-dual-sidebar' ) {  ?>
...
<?php if ( get_theme_mod('infiword_blog_page_layout') == 'right-sidebar' || get_theme_mod('infiword_blog_page_layout') == '' ) {  ?>
