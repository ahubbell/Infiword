                ...
                <ul class="right" >
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_facebook; ?>"><i class="fa fa-facebook-official social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_twitter; ?>"><i class="fa fa-twitter-square social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_github; ?>"><i class="fa fa-github social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_google_plus; ?>"><i class="fa fa-google-plus-square social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_linkedin; ?>"><i class="fa fa-linkedin-square social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_pinterest; ?>"><i class="fa fa-pinterest social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_medium; ?>"><i class="fa fa-medium social-buttons"></i></a></li>
                    <?php } ?>
                    <?php 
                    ...
                    ?>
                        <li><a href="<?php echo $foundationbuddy_social_buttons_youtube; ?>"><i class="fa fa-youtube-play social-buttons"></i></a></li>
                    <?php } ?>
                </ul> 
                <!-- /social-buttons -->