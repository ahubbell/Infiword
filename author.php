...
<?php if ( get_theme_mod('infiword_author_page_layout') == 'full-width' ) {  ?>
...
<?php if ( get_theme_mod('infiword_author_page_layout') == 'left-sidebar' ) {  ?>
...
<?php if ( get_theme_mod('infiword_author_page_layout') == 'dual-sidebar' ) {  ?>
...
<?php if ( get_theme_mod('infiword_author_page_layout') == 'left-dual-sidebar' ) { ?>
...
<?php if ( get_theme_mod('infiword_author_page_layout') == 'right-dual-sidebar' ) {  ?>
...
<?php if ( get_theme_mod('infiword_author_page_layout') == 'right-sidebar' || get_theme_mod('infiword_author_page_layout') == '' ) {  ?>
