<?php
/* ------------------------------------------------------------------------- *
 * The template for displaying the woocommerce page having the 'left-sidebar' layout. This
 * page is called from the 'woocommerce.php' file. The left-sidebar layout will
