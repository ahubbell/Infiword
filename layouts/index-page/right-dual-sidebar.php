<?php
/* ------------------------------------------------------------------------- *
 * The template for displaying the index page having the 'right-dual-sidebar' layout. This
 * page is called from the 'index.php' file. The right-dual-sidebar layout will
